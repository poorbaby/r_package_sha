...
The collected  dataset contains 8 variables related to one individual's sleep and health data and recoded each observation daily. 
...
7. Activity: ActivitybySteps: a measurement of activity in steps
8. HeartRate: heart rate in beats per minute (bpm)
...
The above code give us the number of observations of a dataset. There are 38 observations in the *mydata* dataset
...
So from the above table, we will see that sleep duration of Sunny weather has the longest with 8.37 hour on average , followed by Cloudy and Rainy weather condition, with 7.47 hour,7.44 hour respectively. 
...
**Predicted Heart Rate  = 87.5465 + -0.5328 * Tempreture**
